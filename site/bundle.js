...
/***/ function(module, exports, __webpack_require__) {
	...
	var SyntaxArea = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SyntaxArea = React.createClass({
	  ...
	  _renderOutput: function() {
	    ...
	    if (tokens) {
	      var spans = tokens.map(function(token, index) {
	        return React.createElement("span", {className: parser.identify(tokens[index])}, tokens[index])
	      });
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "syntax-area"}, 
	        React.createElement("div", {className: "output"}, 
	          output
	        ), 

	        React.createElement("textarea", {value: this.state.value, onChange: this._onChange})
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginUtils = __webpack_require__(5);
	var EventPropagators = __webpack_require__(92);
	var SyntheticClipboardEvent = __webpack_require__(114);
	var SyntheticEvent = __webpack_require__(95);
	var SyntheticFocusEvent = __webpack_require__(115);
	var SyntheticKeyboardEvent = __webpack_require__(116);
	var SyntheticMouseEvent = __webpack_require__(97);
